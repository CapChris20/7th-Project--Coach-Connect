...
const LEGACY = {
  'src/ai/chat-api/deepseekService.js': 'src/ai/chat-api/deepseekService.js',
  'src/ai/chat-api/webSearchRouting.js': 'src/ai/chat-api/webSearchRouting.js',
  'src/ai/context/coachPersonalDataRouting.js': 'src/ai/context/coachPersonalDataRouting.js',
  'src/ai/context/coachWeeklyDataClient.js': 'src/ai/context/coachWeeklyDataClient.js',
  'src/ai/context/contextAggregation.js': 'src/ai/context/contextAggregation.js',
  'src/ai/macro-recalibration/macroRecalibration.js': 'src/ai/macro-recalibration/macroRecalibration.js',
  'src/ai/tools/coachDeleteLogRouting.js': 'src/ai/tools/coachDeleteLogRouting.js',
  'src/ai/tools/coachToolProposalGuards.js': 'src/ai/tools/coachToolProposalGuards.js',
  'src/ai/tools/inferCoachToolCallClient.js': 'src/ai/tools/inferCoachToolCallClient.js',
  'src/ai/tools/normalizeToolParams.js': 'src/ai/tools/normalizeToolParams.js',
  'src/ai/tools/toolExecutor.js': 'src/ai/tools/toolExecutor.js',
  'src/ai/trainer-messaging/trainerMessaging.js': 'src/ai/trainer-messaging/trainerMessaging.js',
  'src/ai/vision/imageService.js': 'src/ai/vision/imageService.js',
  'src/aiChat/chat-thread/coachCategoryPrompts.js': 'src/aiChat/chat-thread/coachCategoryPrompts.js',
  'src/aiChat/chat-thread/coachSourcePreview.js': 'src/aiChat/chat-thread/coachSourcePreview.js',
  'src/aiChat/chat-thread/coachAttachmentPickers.js': 'src/aiChat/chat-thread/coachAttachmentPickers.js',
  'src/aiChat/chat-thread/showCoachAttachMenu.js': 'src/aiChat/chat-thread/showCoachAttachMenu.js',
  'src/aiChat/persistence/aiChatPersistence.js': 'src/aiChat/persistence/aiChatPersistence.js',
  'src/aiChat/tool-modals/toolModalShared.js': 'src/aiChat/tool-modals/toolModalShared.js',
  'src/aiChat/voice/useCoachSpeech.js': 'src/aiChat/voice/useCoachSpeech.js',
  ...
  'src/shared/daily-metrics/dailyMetricsService.js': 'src/shared/daily-metrics/dailyMetricsService.js',
  ...
  'src/trainer/crm/trainerClientDisplayName.js': 'src/trainer/crm/trainerClientDisplayName.js',
  'src/trainer/clients-list/clientCRMService.js': 'src/trainer/clients-list/clientCRMService.js',

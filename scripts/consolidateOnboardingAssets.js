...
const assets = [
  // Icons (used by getOnboardingIconSource(...) in OnboardingWizardScreen)
  ...
  // Lottie JSONs (used in OnboardingWizardScreen - both client + trainer flows)
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/personal-info.json'), to: 'personal-info.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/fitness-experience.json'), to: 'fitness-experience.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/fitness-goal.json'), to: 'fitness-goal.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/equipment.json'), to: 'equipment.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/training-frequency.json'), to: 'training-frequency.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/injuries.json'), to: 'injuries.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/trainer-code.json'), to: 'trainer-code.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/role-selection.json'), to: 'role-selection.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/certifications.json'), to: 'certifications.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/experience-timeline.json'), to: 'experience-timeline.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/specialties.json'), to: 'specialties.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/philosophy.json'), to: 'philosophy.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/rates.json'), to: 'rates.json' },
  { from: path.join(repoRoot, 'src/assets/animations/app-flows/invite-code.json'), to: 'invite-code.json' },
];

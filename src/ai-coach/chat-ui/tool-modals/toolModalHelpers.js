 ...
 * tool Modal Shared
 *
 * Purpose: UI screen or component: tool Modal Shared. Feature module for Coach Connect.
 * Why it matters: Keeps feature logic out of screens so auth, nutrition, and trainer rules stay consistent.
 * Area: src/aiChat
 * Key exports: DetailRow, ToolModalBody, ConfirmCancelRow, TOOL_MODAL_COLORS
 *
 * @file-header
 */

 ...
 * height Feet Inches
 *
 * Purpose: height Feet Inches — Feature module for Coach Connect.
 * Why it matters: Keeps feature logic out of screens so auth, nutrition, and trainer rules stay consistent.
 * Area: src/shared
 * Key exports: formatHeightInputDisplay, isHeightComplete, parseHeightInputText, finalizeHeightFromDraft
 *
 * @file-header
 */
/**

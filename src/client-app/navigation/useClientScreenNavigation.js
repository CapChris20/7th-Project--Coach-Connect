...
export function useClientScreenNavigation({ refetchNutritionData } = {}) {
  ...
  const dismissMainOverlays = useCallback(() => {
  ...
  }, [popStackToMainTabs, dismissMainOverlays]);
  ...
  return {
    ...
    /** @deprecated use showClientFilesScreen — kept for ClientMainScreen / shell */
    showNotesFiles: showClientFilesScreen,
    setShowNotesFiles: setShowClientFilesScreen,
    selectedTrainer,
    setSelectedTrainer,
    profileTrainer,
    setProfileTrainer,

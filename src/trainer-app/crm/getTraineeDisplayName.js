/**
 * trainer Client Display Name
 *
 * Purpose: trainer Client Display Name — Feature module for Coach Connect.
 * Why it matters: Keeps feature logic out of screens so auth, nutrition, and trainer rules stay consistent.
 * Area: src/trainer
 * Key exports: isGenericClientDisplayName, isWeakClientDisplayName, resolveTrainerClientDisplayName
 *
 * @file-header
 */
/**

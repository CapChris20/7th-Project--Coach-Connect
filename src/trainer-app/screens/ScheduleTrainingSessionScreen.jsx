 ...
 * Area: src/trainer
 * Key exports: ScheduleTrainingSessionScreen
 *
 * @file-header
 */
...
export const ScheduleTrainingSessionScreen = ({ sessionId, theme = 'dark', onNavigate, initialDate, initialClientId, trainerName }) => {

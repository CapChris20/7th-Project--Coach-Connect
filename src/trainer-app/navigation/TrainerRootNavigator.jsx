...
import {
  TrainerViewMyViewMyProfileScreen,
  ...
  TrainerViewWeekProgressReportScreenOverlay,
...
export default function TrainerRootNavigator() {
  return (
    ...
    >
      ...
      <Stack.Screen name={TRAINER_ROUTES.Profile} component={TrainerViewMyViewMyProfileScreen} options={modalOptions} />
      ...
      <Stack.Screen
        ...
        component={TrainerViewWeekProgressReportScreenOverlay}
        options={modalOptions}
      />

...
import {
  ...
  StatGradientText,
} from './homeStatGradients';
import { DailyQuotePill } from '../../../shared/components/DailyQuoteCard';
import AuroraHeroBanner, { getAuroraHeroGreeting, TODAY_CARD_TOP_STRIPE } from '../../../shared/components/AuroraHeroBanner';
...
// Home stat card value gradients live in ./homeStatGradients.js
                ...
                <View style={styles.statWellnessValueBlock}>
                  <View style={{ position: 'relative', width: '100%' }}>
                    <LightModeOutlineText enabled={!isDark} style={wellnessNumber} align="center">
                      {formatScore(soreness, 10) || soreness}
                    </LightModeOutlineText>

 ...
 * notes File View
 *
 * Purpose: notes File View — Feature module for Coach Connect.
 * Why it matters: Keeps feature logic out of screens so auth, nutrition, and trainer rules stay consistent.
 * Area: src/shared
 * Key exports: isImageFile, isVideoFile, isPdfFile, googleEmbedUrl, officeEmbedUrl, notesFileDedupeKey, getEmbedViewerUri
 *
 * @file-header
 */
/**

...
import { saveTrainerDocument, getTrainerDocument } from '../../../shared/services/notesAndFilesService';
                    ...
                    {FONT_SIZES.map((size) => (
                      fontSize === size ? (
                        <EditorGradientPill key={size} style={styles.pickerChip} radius={8}>
                          ...
                          >
                            <Text style={{ color: theme.textOnAccent, fontWeight: '700', fontSize: 12 }}>{size}</Text>
                          </TouchableOpacity>
                        </EditorGradientPill>
                      ) : (
                        <TouchableOpacity
              ...
              <Pressable style={[styles.promptSheet, { backgroundColor: theme.pageBg, borderColor: theme.border }]} onStartShouldSetResponder={() => true}>
                ...
                <View style={{ flexDirection: 'row', gap: 10, marginTop: 12 }}>
                  ...
                  <EditorGradientPill style={{ flex: 1 }} radius={10}>
                    ...
                    >
                      <Text style={{ color: theme.textOnAccent, fontWeight: '800' }}>Insert</Text>
                    </TouchableOpacity>
                  </EditorGradientPill>
                </View>
              </Pressable>

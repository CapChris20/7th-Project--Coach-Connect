...
} from '../../client/components/home/homeStatGradients';
import {
  GlassCard,
  AuroraHeroBanner,
  Icon,
  ...
  return (
    <View style={{ paddingTop: 4 }}>
      ...
      <View style={{ marginTop: 16 }}>
        ...
        >
          {[
            { key: 'energy', label: 'ENERGY / 5', value: log.dashboard_energy, scale: 5, valueGradient: HOME_STAT_ENERGY_GRADIENT, emptyType: 'energy' },
            { key: 'stress', label: 'STRESS / 10', value: log.dashboard_stress, scale: 10, valueGradient: HOME_STAT_STRESS_GRADIENT, emptyType: 'stress' },
            { key: 'mood', label: 'MOOD / 10', value: log.dashboard_mood, scale: 10, valueGradient: HOME_STAT_MOOD_GRADIENT, emptyType: 'mood' },
            { key: 'soreness', label: 'SORENESS / 10', value: log.dashboard_soreness, scale: 10, valueGradient: HOME_STAT_SORENESS_GRADIENT, emptyType: 'soreness' },
